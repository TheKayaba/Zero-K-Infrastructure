...
namespace ZeroKLobby.MicroLobby
{
    ...
    /// See https://theartofdev.com/2013/08/12/using-native-gdi-for-text-rendering-in-c/ for more information
    ///  </summary>      
    public sealed class NativeTextRenderer : IDisposable
    {
        ...
        public void DrawString(String str, Font font, Color color, Rectangle rect, System.Windows.Forms.TextFormatFlags flags)
        {
            SetFont(font);
            SetTextColor(color);
